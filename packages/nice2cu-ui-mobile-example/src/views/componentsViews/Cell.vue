<template>
	<div class="container">
		<n-nav-bar title="Cell 单元格" show-left left-text="" :shadow-buttom="true" fixed-top placeholder></n-nav-bar>
		<section>
		...
		<section>
			<div class="title">开启水波纹点击反馈（isRipple）</div>
			<div class="content">
				<n-cell title="单元格" description="单元格描述信息" is-ripple></n-cell>
			</div>
		</section>
		<section>
			<div class="title">页面跳转（url/link）</div>
			<div class="content">
		...
		<section>
			<div class="title">插槽（default/icon/description/extra）</div>
			<div class="content">
				<n-cell>
					<template #icon>
