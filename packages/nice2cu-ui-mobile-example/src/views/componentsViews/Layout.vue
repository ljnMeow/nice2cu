<template>
	<div class="container">
		<n-nav-bar title="Layout 布局" show-left left-text="" :shadow-buttom="true" fixed-top placeholder></n-nav-bar>
		<section>
		...
		<section>
			<div class="title">对齐方式（justify）</div>
			<div class="content">
				<div class="item" style="flex: 1">
					<n-row>
						<n-col :span="8"> <span>span-8</span> </n-col>
